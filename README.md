...
3. Зайти в настройки DNS-фильтров (редактор DNS-фильтров) отключить все фильрты (по желанию)
...
6. Paste the link: https://raw.githubusercontent.com/mrtag-oss/blocklistyanmax/refs/heads/main/blacklistadguard.txt
7. Click "Add" (or "Next")
